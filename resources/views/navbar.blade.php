<div class="navbar bg-base-100 mr-4">
  ...
  <svg class="swap-off fill-current w-10 h-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13Zm-9.5,6.69A8.14,8.14,0,0,1,7.08,5.22v.27A10.15,10.15,0,0,0,17.22,15.63a9.79,9.79,0,0,0,2.1-.22A8.11,8.11,0,0,1,12.14,19.73Z"/></svg>
    ...
    <a class="btn btn-warning m-3">Get Location</a>
  ...
  <div class="modal-box relative">
    ...
    <div class="dropdown dropdown-left">
      ...
      <ul tabindex="0" class="menu dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
        ...
        <span class="btn btn-circle avatar border-warning"><img src="{{ asset('images/FoodAppLogo.png' )}}" alt="Application Logo" srcset=""></span>
...
<nav>
  <div class="navbar mr-4 bg-base-100 mx-auto">
    <div class="navbar-start">
      ...
      <div class="dropdown dropdown-bottom">
        <label tabindex="0" class="btn m-1">Lamian &nbsp;&nbsp;<i class="fa-solid fa-sort-down"></i></label>
    ...
    <div class="navbar-end mr-4">
      <button class="btn gap-2">
        ...
        <span>Button To Show Location</span>
      </button>
    </div>
  </div>
</nav>